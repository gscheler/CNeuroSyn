% from run2 with loading of specific graphs
%
N=210;
...
%	A = sm2rnd(N,A_LN,A_R,run_s);
	...
	FN_GRAPHS=sprintf('foo_G_runsingle_%d',run);
	...
	W= W0;      %%%%%%0.06 - (i_k-1)*0.02/length(kS);
	i_k = i_k+1;
...
%
if (verbose),
[mn,st] = plot_nfig11_2018(FN_PLOT, sim, all_nn_inputs', 1, 1, 1);
